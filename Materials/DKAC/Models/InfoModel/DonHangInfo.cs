...
namespace DKAC.Models.InfoModel
{
    ...
    public class ReportNhomVatTuInfo
    {
        public int? id { get; set; }
        public string ten_nhom_vat_tu { get; set; }
        public List<ReportQuyCachInfo> lstQuyCachInfos { get; set; }
    }
    public class ReportQuyCachInfo
    {
        public int? ktp_so_trang { get; set; }
        public double? kgi_rong { get; set; }
        public double? kgi_cao { get; set; }
        public int? sl_giay_chinh { get; set; }
        public double? ki_rong { get; set; }
        public double? ki_cao { get; set; }
        public int? mi_sli_thuc_te { get; set; }
        public List<ReportInInfo> lstInInfo { get; set; }

    }
    public class ReportInInfo
    {
        public int? mi_tren { get; set; }
        public int? mi_duoi { get; set; }
        public int? mi_trang { get; set; }
        public List<ReportKemInInfo> lstKemInInfos { get; set; }
    }
    public class ReportKemInInfo
    {
